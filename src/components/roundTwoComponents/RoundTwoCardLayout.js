...
function RoundTwoCardLayout(props) {//The state of this component is synced with RoundTwo.js, as each time a card is chosen it updates/modify the state of RoundTwo.js.
...
export default RoundTwoCardLayout