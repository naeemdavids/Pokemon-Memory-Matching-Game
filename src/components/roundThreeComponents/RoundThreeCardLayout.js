...
function RoundThreeCardLayout(props) {//The state of this component is synced with RoundThree.js, as each time a card is chosen it updates/modify the state of RoundThree.js.
...
export default RoundThreeCardLayout